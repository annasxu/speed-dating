...
data = data.frame(Speed_Dating_Data$like,Speed_Dating_Data$samerace,Speed_Dating_Data$int_corr,Speed_Dating_Data$attr,Speed_Dating_Data$sinc+Speed_Dating_Data$intel,Speed_Dating_Data$fun,Speed_Dating_Data$amb,Speed_Dating_Data$shar)
